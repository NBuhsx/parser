...
def data_for_get_coordinat(adress:str) -> Dict:
    return  {
            "query":"\n  query($input: SearchByAddressInput!) {\n    geocode: searchByAddress(input: $input) {\n      \n  text\n  kind\n  precision\n  lat\n  long\n\n    }\n  }\n",
            "variables": "{\"input\":{\"search\":\"" + adress + " \"}}"}


def data_for_set_adress(adress:str, coordinats:tuple) -> Dict:
    return {
...
def data_for_get_category() -> Dict:
...
def data_for_get_products(category_id:int|str, limit:int|str, page:int|str) -> Dict:
    return {
...
{\"page\":{\"page\":" + str(page) + ",\"limit\":" + str(limit) + "},\"sort\":{\"param\":\"default\",\"direct\":\"asc\"},\"filter\":{\"byCategoryId\":" + str(category_id) + "}}}"}
